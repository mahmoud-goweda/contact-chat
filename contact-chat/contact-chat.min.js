function newTime() {
    ...
    $.fn.contactmessegeButton = function(options) {
        var settings = $.extend({ id_phone: "", message: "", messengerType: '', chatMessage: "Hi there 👋", size: "72px", buttonColor: "rgb(9, 94, 84)", position: "left", linkButton: !1, showPopup: !1, showOnIE: !0, autoOpenTimeout: 0, headerColor: "rgb(9, 94, 84)", avatar: "", nameClient: "", headerTitle: "", zIndex: 0, buttonImage: "./assets/whatsapp.svg" }, options),
            isMobile = mobilecheck();
        this.addClass("contactmessege-button");
        ...
        function sendWhatsappMessage() {
            ...
            var apilink = "http://";
            apilink += mobilechecker() ? "api" : "web", apilink += ".whatsapp.com/send?phone=" + settings.id_phone + "&text=" + encodeURI(settings.message), window.open(apilink)
            console.log(apilink);
        }
